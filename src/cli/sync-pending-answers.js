...
const { cleanQuestionLabel, PENDING_FILE, LEDGER_FILE } = require("../core/answer-ledger");
const { getAnswer } = require("../core/answer-engine");
const { isAutoHandledQuestion } = require("../core/question-filters");
const { loadProfile } = require("../core/profile-loader");

const PROFILE_PATH = process.env.JOB_AUTO_APPLY_PROFILE || "profile.json";

const { shouldIgnoreQuestion } = require("../core/question-filters");
