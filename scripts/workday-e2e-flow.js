...
const { prepareWorkdayApplication, detectCurrentStep } = require("../workday-adapter");
const { buildApplicationContext } = require("../job-context");
...
const { DEFAULT_WORKDAY_PASSWORD } = require("../workday-accounts");
